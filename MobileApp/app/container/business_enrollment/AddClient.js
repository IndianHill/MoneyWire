...
// Styles
import styles from './Styles/AddClientStyle'
    ...
    renderTitleView = () => {
        return (
            <View style={styles.titleView}>
                <Text style={styles.titleText}>Add your client account ?</Text>
            </View>
        )
    }

    renderTitleDescpView = () => {
        let descpStr = "To setup your account and request client company data access"
        return (
    ...
    renderPrimaryPOCName = () => {
        return (
            <View style={styles.formFieldView}>
                <TextField
                    label='Client Account Primary POC Name'
            ...
            <View style={styles.bottomView}>
                <View>
                    <TouchableOpacity onPress={ () => {  }}
                        ...
                        <Text style={styles.addDelegateText}>Request Access</Text>
                    </TouchableOpacity>
                </View>
                <View>
                    <TouchableOpacity onPress={ () => {  }}
